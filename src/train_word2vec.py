...
def accuracy(filein, question):
    model = gensim.models.KeyedVectors.load_word2vec_format(filein, binary=False)
    model.accuracy(question)
    
if __name__ == '__main__':
    print 'BEGIN'
#     file_in = generate_traning_data("joininput", "output")
#     train(file_in, "output/wordvector", 0, 1, 300, 0.025, 5, 5, 8, 0)
    accuracy("neww2vec.model", "question")
#     accuracy("2gramoutput/w2v_format_skipgram_300.model", "question")
    print 'END'
